...
{
    public class CMTestsDbContext: DbContext
    {
        /// <summary>
        /// DBContext constructor
        /// </summary>
        /// <param name="options">DbContextOptions<CMTestsDbContext> - DbContext config data: sql provider, connection string, etc.</param>
        public CMTestsDbContext(DbContextOptions<CMTestsDbContext> options) : base(options)
        {
